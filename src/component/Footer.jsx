        ...
        <div className='border-b border-gray-400 text-[9px] md:text-xs px-1 md:px-[20%]' >
                    <div className='grid grid-cols-5 my-5'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <ul className='text-[9px] md:text-xs text-gray-500 flex flex-col md:gap-4'>
                                <li className='hover:cursor-pointer hover:underline'>Apple and Government</li>
                            </ul>
                        </div>
                    ...
                    <div className='text-[9px] md:text-xs text-gray-500 my-2 md:my-5'>
                        <p>More ways to shop: <a href="" className='text-blue-500 underline'>Find an Apple Store</a> or <a href="" className='text-blue-500 underline'>other retailer</a> near you. Or call <a href="" className='text-blue-500 underline'>000800 040 1966</a></p>
                    </div>
                </div>
